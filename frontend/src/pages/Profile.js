...
useEffect(() => {
  setActiveTab('profile'); // Reset to profile tab whenever userId changes
}, [userId]);
  ...
  return (
    <div className="min-h-screen bg-[#14181c] pt-[72px] ">
      ...
      {/* <div className="bg-[#2c3440]">
        ...
        {/* Profile Header */}
    <div className="bg-[#2c3440]">
      <div className="max-w-[1200px] mx-auto px-2 py-6 sm:px-4 sm:py-12">
  ...
  >
    {isFollowing ? 'Following' : 'Follow'}
     ...
     <ProfileTabs 
          ...
          onSelectFavorites={() => setSelectingFavorites(true)}
