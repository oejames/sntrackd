        ...
        for video in videos:
            try:
                ...
                video_data = {
                    ...
                    'importDate': (datetime.now().replace(year=datetime.now().year - 10)).isoformat(), ## changing to 10 years ago bc order of og imports was latest to newest so the new sketches show up as 'newest'
