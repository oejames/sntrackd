        ...
        for video in videos:
            try:
                ...
                video_data = {
                    ...
                    'importDate': (datetime.now().replace(year=datetime.now().year - 40)).isoformat(), ## changing to [whatever imiport year is] ]years ago bc order of og imports was latest to newest so the new sketches show up as 'newest'
