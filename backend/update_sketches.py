        ...
        for video in videos:
            try:
                ...
                video_data = {
                    ...
                    'importDate': (datetime.now().replace(year=datetime.now().year - 4)).isoformat(), ## changing to 4 years ago bc order of og imports was latest to newest so the new sketches show up as 'newest'
